                            ...
                            <div class="box-body" >
                                <form action="" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-11">
                                            <input type="text" value="<?=$userDetail['full_name']??''?>"   name="full_name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="date" class="form-control" name="date" value="<?=$userDetail['date']??''?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <select name="role" id="role" class="form-control">
                                                <option value="1" <?php if ($userDetail['role'] == '1') { echo 'selected'; } ?>>Admin</option>
                                                <option value="2" <?php if ($userDetail['role'] == '2') { echo 'selected'; } ?>>Employee</option>
                                            </select>
                                        </div>
                                    ...
                                    if (isset($_REQUEST['btn-update'])) {
                                        $data = [];
                                        $data['birthday'] = $_REQUEST['date']??$userDetail['date'];
                                        $data['role'] = $_REQUEST['role']??$userDetail['role'];
                                        $data['phone'] = $_REQUEST['phone']??$userDetail['phone'];
                                        $data['full_name'] = $_REQUEST['full_name']??$userDetail['full_name'];
